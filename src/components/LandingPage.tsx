...
export default function LandingPage() {
  ...
  useEffect(() => {
    const track = (e: MouseEvent) => {
      ...
      const range = 350;
      setGlowIntensity(dist < range ? (range - dist) / range : 0);
    };
  ...
  const scale       = 1 - progress * 0.55;        // 1.0 → 0.45
  const rotateY     = progress * 1080;            // Y-axis revolve — 3 full flips
  const translateY  = progress * -250;            // float upward
  ...
  return (
    <main className="relative min-h-screen text-white selection:bg-violet-500/30 selection:text-violet-200 overflow-x-hidden">
      ...
      />
      {/* Vivid purple orbs to add depth */}
      ...
      <section className="relative h-screen w-full flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        {/* ── Revolving logo — perspective wrapper for 3-D effect ── */}
        <div style={{ perspective: "900px", perspectiveOrigin: "50% 50%" }}>
          <div
            ...
            style={{
              ...
              filter: `drop-shadow(0 0 ${glowBlur}px rgba(139, 92, 246, ${glowAlpha}))
                       drop-shadow(0 0 ${Math.round(glowBlur * 0.45)}px rgba(167, 139, 250, ${glowAlpha * 0.55}))`,
        ...
        >
          <h1
            className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-tight max-w-3xl"
            style={{
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32 pointer-events-none"
          style={{ background: "linear-gradient(to top, rgba(2,0,16,0.8), transparent)" }} />
      </section>
      ...
      {/* ═══════════════════════════════════════════════════
          SECTION 2 — PRODUCTS
      ═══════════════════════════════════════════════════ */}
      <section id="products" className="relative max-w-6xl mx-auto px-6 py-20 z-10">

        {/* Section header */}
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-mono mb-5 border"
            style={{ background: "rgba(109,40,217,0.1)", borderColor: "rgba(139,92,246,0.25)", color: "#a78bfa" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(145deg, rgba(15,5,30,0.9) 0%, rgba(20,8,45,0.85) 100%)",
              border: "1px solid rgba(139,92,246,0.2)",
              backdropFilter: "blur(16px)",
              boxShadow: "0 8px 40px rgba(109,40,217,0.12), inset 0 1px 0 rgba(255,255,255,0.04)",
            }}
            onMouseEnter={e => (e.currentTarget.style.boxShadow = "0 12px 60px rgba(109,40,217,0.28), inset 0 1px 0 rgba(255,255,255,0.06), 0 0 0 1px rgba(139,92,246,0.35)")}
            onMouseLeave={e => (e.currentTarget.style.boxShadow = "0 8px 40px rgba(109,40,217,0.12), inset 0 1px 0 rgba(255,255,255,0.04)")}
          >
            ...
            {/* Swiper Sandbox */}
            <div
              className="relative flex flex-col items-center justify-center flex-1 min-h-[380px] rounded-2xl overflow-hidden p-6"
              style={{ background: "rgba(5,2,15,0.7)", border: "1px solid rgba(109,40,217,0.15)" }}
            >
              {/* Match overlay */}
              {matched && (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center"
                  style={{ background: "rgba(46,16,101,0.94)", backdropFilter: "blur(4px)" }}>
                  <div className="w-20 h-20 rounded-full flex items-center justify-center mb-4"
                    style={{ background: "rgba(139,92,246,0.2)", border: "2px solid rgba(167,139,250,0.5)", boxShadow: "0 0 30px rgba(139,92,246,0.4)" }}>
              ...
              {/* Card */}
              <div
                className="w-full max-w-[290px] rounded-2xl p-5"
                style={{
                  background: "linear-gradient(160deg, rgba(20,8,40,0.95) 0%, rgba(10,4,25,0.95) 100%)",
                  ...
                  transition: swipeDir ? "transform 0.4s ease-in, opacity 0.3s ease-in" : "none",
                }}
              >
                {/* Avatar */}
                <div className="w-full h-28 rounded-xl mb-4 flex items-center justify-center relative overflow-hidden"
                  ...
                  <div className="absolute inset-0" style={{
                    background: "radial-gradient(circle at 30% 40%, rgba(167,139,250,0.15) 0%, transparent 60%)"
                  }} />
                  ...
                  <div className="absolute top-2 right-2 flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px]"
                    style={{ background: "rgba(0,0,0,0.6)", border: "1px solid rgba(139,92,246,0.4)", color: "#c4b5fd" }}>
              ...
              <div className="flex items-center gap-8 mt-6">
                <button onClick={() => handleSwipe("left")}
                  ...
                  style={{ background: "rgba(15,5,25,0.9)", border: "1px solid rgba(239,68,68,0.35)", color: "#f87171" }}
                ...
                <button onClick={() => handleSwipe("right")}
                  className="w-14 h-14 rounded-full flex items-center justify-center transition-all active:scale-95 cursor-pointer"
                  style={{ background: "rgba(15,5,25,0.9)", border: "1px solid rgba(52,211,153,0.35)", color: "#34d399" }}
          ...
          >
            ...
            {/* Terminal Shell */}
            <div className="relative flex flex-col flex-1 min-h-[380px] rounded-2xl overflow-hidden font-mono text-xs"
              style={{ background: "#050210", border: "1px solid rgba(109,40,217,0.2)" }}>

              {/* Title bar */}
              <div className="flex items-center justify-between px-4 py-3"
                style={{ background: "rgba(15,5,30,0.9)", borderBottom: "1px solid rgba(109,40,217,0.15)" }}>
                <div className="flex items-center gap-2">
                  ...
                  <span className="ml-3 text-[11px]" style={{ color: "#6b7280" }}>nova-agent-shell — GAIL RFP</span>
                </div>
              ...
              <div className="flex-1 p-4 space-y-3 overflow-y-auto" style={{ maxHeight: "280px" }}>
                {terminalLogs.length === 0 ? (
                  <span style={{ color: "#4b5563" }} className="italic">
                  ...
                  <div key={i} className="space-y-0.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] px-1.5 py-0.5 rounded" style={{ background: "rgba(52,211,153,0.1)", color: "#6ee7b7" }}>active</span>
                    </div>
                    <div className="pl-4" style={{ color: "#d1d5db" }}>{log.message}</div>
                  </div>
                ))}
                {terminalRunning && (
                  <div className="flex items-center gap-2 pl-4" style={{ color: "#8b5cf6" }}>
              ...
              <div className="px-4 py-4 flex items-center justify-between"
                style={{ background: "rgba(10,4,25,0.8)", borderTop: "1px solid rgba(109,40,217,0.12)" }}>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2 rounded-lg font-semibold transition-all active:scale-95 cursor-pointer"
                  style={{
                    background: terminalRunning ? "rgba(109,40,217,0.1)" : "linear-gradient(135deg, #7c3aed, #5b21b6)",
                    border: "1px solid rgba(139,92,246,0.4)",
                    color: terminalRunning ? "#6d28d9" : "#ffffff",
                    boxShadow: terminalRunning ? "none" : "0 0 20px rgba(124,58,237,0.35)",
                  }}
                >
      ...
      {/* ═══════════════════════════════════════════════════
          SECTION 3 — TEAM
      ═══════════════════════════════════════════════════ */}
      <section id="team" className="relative max-w-4xl mx-auto px-6 py-24 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div
              key={person.name}
              className="group flex flex-col items-center text-center rounded-3xl p-8 transition-all duration-300 relative overflow-hidden"
              style={{
                background: "linear-gradient(160deg, rgba(15,5,30,0.92) 0%, rgba(10,4,22,0.88) 100%)",
                border: "1px solid rgba(139,92,246,0.2)",
                backdropFilter: "blur(20px)",
                boxShadow: "0 8px 40px rgba(109,40,217,0.1)",
              }}
              onMouseEnter={e => {
                (e.currentTarget.style.boxShadow = "0 16px 60px rgba(109,40,217,0.3), 0 0 0 1px rgba(167,139,250,0.4)");
                (e.currentTarget.style.transform = "translateY(-4px)");
              }}
              onMouseLeave={e => {
                (e.currentTarget.style.boxShadow = "0 8px 40px rgba(109,40,217,0.1)");
                (e.currentTarget.style.transform = "translateY(0)");
              }}
            >
              {/* Holographic shimmer */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                style={{ background: "linear-gradient(135deg, rgba(167,139,250,0.06) 0%, transparent 40%, rgba(99,102,241,0.06) 100%)" }} />

              {/* Avatar */}
              <div className="w-24 h-24 rounded-2xl mb-5 flex items-center justify-center relative overflow-hidden"
                style={{ background: person.grad, border: "1px solid rgba(139,92,246,0.4)", boxShadow: "0 8px 30px rgba(109,40,217,0.3)" }}>
                <span className="text-3xl font-black" style={{ color: "rgba(196,181,253,0.9)" }}>{person.initials}</span>
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity"
                  style={{ background: "linear-gradient(135deg, rgba(167,139,250,0.25) 0%, transparent 60%)" }} />
              </div>
              ...
              <div className="flex items-center gap-3">
                {[
                  ...
                  <a key={label} href={href} target={href.startsWith("http") ? "_blank" : undefined}
                    ...
                    style={{ background: "rgba(10,4,25,0.9)", border: "1px solid rgba(80,60,120,0.4)", color: "#6b7280" }}
                    onMouseEnter={e => {
                      (e.currentTarget.style.color = "#c4b5fd");
                      (e.currentTarget.style.borderColor = "rgba(139,92,246,0.6)");
                      (e.currentTarget.style.boxShadow = "0 0 15px rgba(109,40,217,0.35)");
                    }}
                    onMouseLeave={e => {
      ...
      {/* ═══════════════════════════════════════════════════
          SECTION 4 — FOOTER
      ═══════════════════════════════════════════════════ */}
      <footer className="relative z-10 py-12" style={{ borderTop: "1px solid rgba(109,40,217,0.15)", background: "rgba(2,0,10,0.85)" }}>
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <Image src="/logo-v2.svg" alt="SIDHI AI" width={32} height={32} className="opacity-70" />
            <div>
              <p className="text-xs font-mono" style={{ color: "#4b5563" }}>
                © {new Date().getFullYear()} SIDHI AI. All rights reserved.
              </p>
              <p className="text-[10px] font-mono mt-0.5" style={{ color: "rgba(139,92,246,0.5)" }}>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="h-4 w-px" style={{ background: "rgba(109,40,217,0.2)" }} />
            {[{ href: "#products", label: "Products" }, { href: "#team", label: "Team" }, { href: "mailto:contact@sidhiai.in", label: "Support" }].map(({ href, label }) => (
